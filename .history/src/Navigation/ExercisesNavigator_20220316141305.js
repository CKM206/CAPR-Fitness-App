...
const ExerciseCreateModalNavigator = () => {
    return (
        <ExerciseCreateModal.Navigator mode='modal'>
            <ExerciseCreateModal.Screen name='ExerciseCreate' component={ExerciseCreateScreen}/>
...
const ExercisesStackNavigator = () => {
    return (
                    ...
                    headerRight: () => (
                        <HeaderButtons HeaderButtonComponent={DynamicHeaderButton}>
                            <Item
                                ...
                                iconName={'ios-add'}
                                onPress={() => navigation.navigate('ExerciseCreateModal')}
                            />
                        </HeaderButtons>
                    ),
                })
        ...
        <ExercisesStack.Screen name='ExerciseDetail'
                ...
                option={{}}    
        />
        <ExercisesStack.Screen name='ExerciseCreateModal'
                component={ExerciseCreateModalNavigator}
                option={{}}    
        />
        </ExercisesStack.Navigator>
    );
