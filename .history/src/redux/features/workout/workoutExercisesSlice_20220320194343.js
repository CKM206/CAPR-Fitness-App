import { createAsyncThunk, createSlice, createEntityAdapter, useSelector, useDispatch } from "@reduxjs/toolkit";
...
async (exercisesToAdd, { getState }) => {
    try {
        ...
        let startingIndex = dispatch(getNumberOfEntities);
...
const getNumberOfEntities = useSelector(state => state.entities.length);
