import { createAsyncThunk, nanoid, createSlice, createEntityAdapter, useSelector} from "@reduxjs/toolkit";
import fitnessApi from '../../../api/fitnessApi';
import { cancel_workout } from "./workoutSlice";
import { add_sets, add_exercise_set, remove_exercise_set, remove_sets, selectAllSets } from '../workout/workoutSetsSlice';
...
export const selectExerciseSets = (state, props) = useSelector(
    [selectAllSets],
    (sets) => sets.filter(set => props.sets.includes(set._id))
);
