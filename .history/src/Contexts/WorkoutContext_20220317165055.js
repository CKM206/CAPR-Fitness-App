    ...
    switch (action.type) {
        ...
        case 'add_set':
            ...
            if (typeof exerciseForSet.sets == 'undefined')
            {
             ...
             const newSet = {
                set:  isFirstSet ?  1 : exerciseForSet.sets.length() + 1,
                reps: 0,
                weight: 0,
                duration: 0,
                rest: 0,
            ...
            if (isFirstSet)
            {
                return {...state, sets: newSet};

            }
            
            exerciseForSet.sets.push(newSet);
            return {...state, sets: exerciseForSet.sets};
 ...
 */
 ...
 const addExercises = (dispatch) => {
    return async (arrayOfExercises) => {
        ...
        NavigationRef.navigate('WorkoutStack', { screen: 'WorkoutDetail', props: {exercises: null}})
...
const changeTitle = (dispatch) => {
    ...
    //NavigationRef.navigate('WorkoutStack', {screen: 'WorkoutDetail'})
    //console.log(title);
    }
};
