    ...
    switch (action.type) {
        case 'add_exercises':
            action.payload.forEach(element => {
                let oldExercises = state.exercises;

                oldExercises.push({name: element.name, exerciseType: element.exerciseType, muscles: element.muscles, force: element.force, _id: element._id});
            })
        case 'edit_title':
