...
import { begin_workout } from '../../redux/features/workout/workoutsSlice';
...
const WorkoutDetailScreen = ({navigation, route}) => {
    ...
    useEffect(() => {
        console.log('Begining A New Workout!')
        dispatch(begin_workout({ title, note, paused, timeStarted: Date()}))
    },[]);
