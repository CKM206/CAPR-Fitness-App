...
// Imports | 3rd Party
import { Text, Card, Title, Subheading, Button, IconButton, Paragraph } from 'react-native-paper';
// Imports | Components 
        ...
        <View style={styles.screen}>
            <ScrollView>
                <Card mode='outlined' elevation={1} style={{ borderRadius: 15 }} >
                    <Card.Title titleStyle={{alignSelf: 'center'}} title='Program Title' subtitle='User' right={(props) => <IconButton {...props} icon="ellipsis-vertical" onPress={() => {}} />}/>
                    <Card.Content><Text>Additional Program Info here</Text></Card.Content>
                </Card>
            </ScrollView>
        </View>
    );
