...
import { begin_workout, selectActiveWorkout, change_title } from '../../redux/features/workout/workoutSlice';
...
const WorkoutDetailScreen = ({navigation, route}) => {
    ...
    // State Config
    const [ title, setTitle ] = useState(activeWorkout._title);
                ...
                ListHeaderComponent={
                    <>
                        <TextInput style={styles.textInput} 
                            ...
                            onBlur={(text) => dispatch(change_title({_id: activeWorkout._id, title: title  })) }
                        />           
                        <TextInput style={styles.textInput}
                            value={note}
                            mode='flat' 
