...
import { begin_workout, selectActiveWorkoutId, change_title } from '../../redux/features/workout/workoutSlice';
                ...
                ListHeaderComponent={
                    <>
                        <TextInput style={styles.textInput} 
                            ...
                            onEndEditing={ (text) => dispatch(change_title({_id: activeWorkoutId, changes: { title: text } })) }
                        />           
                        <TextInput style={styles.textInput}
                            value={note}
                            mode='flat' 
