...
const WorkoutSelectionScreen = (props) => {
    ...
    return ( 
        <View style={styles.screen}>
            <ScrollView>
                <Card mode='outlined' elevation={1} style={{ borderRadius: 15, alignItems:'center'}} >
                    <Card.Title title='Title' subtitle='SubTitle' right={(props) => <IconButton {...props} icon="more-vert" onPress={() => {}} />}/>
