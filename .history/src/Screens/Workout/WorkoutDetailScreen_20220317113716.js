...
const WorkoutDetailScreen = ({navigation}) => {
    ...
    //     );
    // }
    const headerComponent = (title, note) => {
        return (
            <>
            <TextInput 
                value={title} 
    ...
    return ( 
        <View>
            <FlatList 
                ...
                ListHeaderComponent={headerComponent(item.title)}
                ListFooterComponent={footerComponent(item.note)}
