                                    ...
                                    return (
                                        ...
                                        <View style={styles.parentRow}>
                                            ...
                                            ? <View style={styles.metricsRow}>
                                                ...
                                                <TextInput selection={{start: 0, end:999}} value={`${sets.item.weight}`} placeholder='-' dense/>
                                                <Caption>Reps</Caption> 
                                                <TextInput value={`${sets.item.reps}`} placeholder='-' dense/>
                                              </View>
                                            : <TextInput placeholder='-' dense/>}
                                            <Checkbox />
                                        </View>    
                                        </>
                                    );
