...
const MetricsTitleComponent = ({exerciseType}) => {
    ...
    switch(exerciseType){
        ...
        case 'Cardio':
            return (
                <>
                    <Caption style={{ marginHorizontal: 8 }}>Distance</Caption>
                    <Caption style={{ marginHorizontal: 10 }}>Duration</Caption>
                </>
            );
        default:
                            ...
                            <>                              
                                <View style={styles.setRow}>
                                    <View style={styles.setInfo}>
                                        ...
                                        <View style={{flex:2, flexDirection: 'row', justifyContent: 'flex-start', borderWidth: 1}}>
                                            <Caption>9999lbs x 9999</Caption> 
                                        </View> 
                                    </View>    
                                    <View style={styles.metricsInfo}>     
