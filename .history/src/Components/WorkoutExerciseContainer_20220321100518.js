                        ...
                        return (
                            <>
                                ...
                                <View style={styles.parentRow}>
                                    ...
                                    <TextInput style={{ backgroundColor: 'transparent'}} keyboardType='numeric' value={`${item.set.weight}`} placeholder='-' dense/>
                                    <Caption>Reps</Caption> 
                                    <TextInput style={{ backgroundColor: 'transparent'}} keyboardType='numeric' value={`${item.set.reps}`} placeholder='-' dense/>
                                    </View>
