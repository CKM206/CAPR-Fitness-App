...
import { Button, RadioButton, Text, Subheading } from 'react-native-paper';
// Imports | Components 
...
const ExerciseForm = ({initialValues}) => {
    ...
    return (
        ...
        <Subheading>Exercise Type</Subheading>
            ...
            <Button icon='checkmark-circle' mode='text' compact onPress={() => console.log('Pressed!')}>Press me</Button>
        </>
    );
