...
import {add_set, addSetToExercise} from '../redux/features/workout/workoutSetsSlice';
import { selectAllExercises, selectExerciseById, selectSetsOfExercise } from '../redux/features/exercises/exercisesSlice';
                    ...
                    ListFooterComponent={
                        <>
                            <Button labelStyle={{fontSize: 12}} compact onPress={(state) => {
                                dispatch(addSetToExercise({ _id: currentNumberOfSets, reps: 0, weight: 0, duration: 0, restTimer: 0, isComplete: false, exercise_id: workoutExercise._id }))
                            }}>
                            Add Set
                            </Button>
                        </>
