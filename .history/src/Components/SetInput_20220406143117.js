...
// Imports | 3rd Party
import { Caption, TextInput, IconButton, Snackbar } from 'react-native-paper';
...
const SetInput = ({ setId, exerciseType }) => {
    ...
    const attemptComplete = () => {
        ...
        {
            console.log('Not Completing!')
            return (
                <>
                    <Snackbar visible={true} style={{position: 'absolute'}} label='close' >
                        Please Enter Set Metrics to Complete
                    </Snackbar>
                </>
            );
        }
