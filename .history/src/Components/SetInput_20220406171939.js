        ...
        {exerciseType === 'Cardio' 
            ...
            :
                <TextInput 
                    ...
                    selectTextOnFocus
                    onChangeText={(text) => setDuration(text.replace(/00:/g, ''))}
                    ...
                    render={props =>
                        <MaskedTextInput
                        {...props}
                        mask={ duration.length < 2 ? '0:09' : duration.length < 3 ? '00:99' : duration.length < 4 ? '0:09:99' : duration.length < 5 ? '00:99:99' : '09:99:99'}
                        />
                    }
                />
            }
