...
const WorkoutExerciseContainer = ({ workoutExercise }) => {
    ...
    const exercise = useSelector((state) => selectExerciseById(state, workoutExercise._id))
                    ...
                    ListFooterComponent={
                        <>
                            <Button labelStyle={{fontSize: 12}} compact onPress={(state) => {
                                dispatch(add_set({ workoutExercise_id: workoutExercise.exercise_id, reps: 0, weight: 0,  restTimer: 0}))
                            }}>
                            Add Set
                            </Button>
                        </>
