                ...
                <SwipeListView 
                    ...
                    renderHiddenItem={ (data, rowMap) => (
                        <View style={styles.hiddenRow}>
                            <Avatar.Icon style={styles.trashIcon} size={24} color='white' icon='ios-trash' />
                        </View>
                    )}
                    ...
                    disableRightSwipe
                    friction={100}
                    onRowDidOpen={() => dispatch(remove_exercise_set({_id: item, exercise_id: workoutExercise._id }))}
                />
            </View>
        </>
    );
