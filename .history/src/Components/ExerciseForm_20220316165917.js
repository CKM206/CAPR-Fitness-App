...
const ExerciseTypeForm = (props) => {
    ...
    return ( 
        <>
            ...
            <View style={styles.row}>
                <Button 
                    icon={ equipment === 'Chest' 
                        ? <Ionicons name="checkmark-circle" size={20} color="green" />
                        : <Ionicons name="checkmark-circle-outline" size={20} color="black" /> } 
                    title='Chest' 
                    type='clear' 
                    onPress={()=> setEquipment('Chest')}
                />
                <Button 
                    icon={ equipment === 'Back' 
                    ? <Ionicons name="checkmark-circle" size={20} color="green" />
                    ...
                    title='Back' 
                    type='clear' 
                    onPress={()=> setEquipment('Back')}
                />
                <Button 
                    icon={ equipment === 'Shoulders' 
                    ? <Ionicons name="checkmark-circle" size={20} color="green" />
                    : <Ionicons name="checkmark-circle-outline" size={20} color="black" /> } 
                    title='Shoulders' 
                    type='clear' 
                    onPress={()=> setEquipment('Shoulders')}
                />
                <Button 
                    icon={ equipment === 'Legs' 
                    ? <Ionicons name="checkmark-circle" size={20} color="green" />
            ...
            <View style={styles.row}>
                ...
                <Button 
                    ...
                    title='Core' 
                    type='clear' 
                    onPress={()=> setEquipment('Core')}
                />
                <Button 
                    icon={ equipment === 'Full body' 
                    ? <Ionicons name="checkmark-circle" size={20} color="green" />
                    : <Ionicons name="checkmark-circle-outline" size={20} color="black" /> } 
                    title='Full body' 
                    type='clear' 
                    onPress={()=> setEquipment('Full body')}
                />
            </View>
