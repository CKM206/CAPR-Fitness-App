...
const MetricsTitleComponent = ({exerciseType}) => {
    ...
    switch(exerciseType){
        case 'Strength':
            return (
                <>
                    <Caption style={{width: 65, borderWidth: 1, textAlign: 'center'}}>Weight</Caption>
                    <Caption style={{width: 65, borderWidth: 1, textAlign: 'center'}}>Reps</Caption>
                </>
            );
        case 'Timed':
            return (
                <>
                    <Caption style={{width: 65, borderWidth: 1, textAlign: 'center'}}>Weight</Caption>
                    <Caption style={{width: 95, borderWidth: 1, textAlign: 'center'}}>Duration</Caption>
                </>
            );
        case 'Cardio':
            return (
                <>
                    <Caption style={{width: 65, borderWidth: 1, textAlign: 'center'}}>Distance</Caption>
                    <Caption style={{width: 95, borderWidth: 1, textAlign: 'center'}}>Duration</Caption>
                </>
            );
        default:
        ...
        <View style={styles.exerciseCard}>
            ...
            <View style={styles.headingRow}>
                ...
                <View style={styles.metricsInfo}>
                    <View style={{flex:4, flexDirection: 'row', justifyContent: 'space-evenly', borderWidth: 1}}>
