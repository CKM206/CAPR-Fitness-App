...
const SetInput = ({ setId }) => {
    ...
    const [weight, setWeight] = useState(set ? set.reps.toString() : '');
    ...
    return ( 
        <>
            <TextInput 
                ...
                onBlur={() => dispatch(update_set({ _id: setId, changes: { weight: weight } })) }
                value={weight}
            />
            <TextInput 
                style={styles.metricsInput} 
                ...
                onBlur={() => dispatch(update_set({ _id: setId, changes: { reps: reps } })) }
                value={reps}
            />
