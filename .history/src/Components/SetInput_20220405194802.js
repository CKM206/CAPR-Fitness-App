    ...
    return ( 
        <>
            <View style={styles.setInputContainer}>
                ...
                <TextInput style={{ backgroundColor: 'transparent'}} maxLength={4} caretHidden keyboardType='numeric' placeholder='----' mode='outlined' dense/>
                <Caption>Reps</Caption> 
                <TextInput style={{ backgroundColor: 'transparent'}} maxLength={4} keyboardType='numeric' placeholder='----' mode='outlined' dense/>
