                ...
                <View style={styles.row}>
                    <RadioButton 
                        ...
                        onPress={()=> exerciseType === 'Cardio'  
                            ? dispatch({type: 'change_type', payload: { type: 'Stength', muscles: initialValues.muscles, equipment: initialValues.equipment, force: initialValues.force}})
                    ...
                    <RadioButton 
                        ...
                        onPress={()=> exerciseType === 'Cardio'  
                            ? dispatch({type: 'change_type', payload: { type: 'Timed', muscles: initialValues.muscles, equipment: initialValues.equipment, force: initialValues.force}})
