            ...
            <Subheading>Exercise Type</Subheading>
                <View style={styles.row}>
                    <RadioButton 
                        ...
                        onPress={()=> dispatch({type: 'change_type', payload: { type: 'Strength', muscles: initialValues.muscles, equipment: initialValues.equipment, force: initialValues.force}})}
                    />
                    <Text>Strength</Text>
                    <RadioButton 
                        value='Timed' 
                        status={ exerciseType === 'Timed' ? 'checked' : 'unchecked'} 
                        onPress={()=> dispatch({type: 'change_type', payload: { type: 'Timed', muscles: initialValues.muscles, equipment: initialValues.equipment, force: initialValues.force}})}
                    />
                    <Text>Timed</Text>
                    <RadioButton 
                        value='Cardio' 
                        status={ exerciseType === 'Cardio' ? 'checked' : 'unchecked'} 
                        onPress={()=> dispatch({type: 'change_type', payload: { type: 'Cardio', muscles: initialValues.muscles, equipment: initialValues.equipment, force: initialValues.force}})}
                    />
                    <Text>Cardio</Text>
                </View>
