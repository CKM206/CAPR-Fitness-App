...
import { selectExerciseSets } from '../redux/features/workout/workoutExercisesSlice';
...
const WorkoutExerciseContainer = ({ workoutExercise }) => {
    ...
    const exerciseSets = useSelector(selectExerciseSets(workoutExercise ))
    console.log('WORKOUT CONTAINER RENDERING');
    return ( 
        <>
                    ...
                    ListFooterComponent={
                        <>
                            <Button labelStyle={{fontSize: 12}} compact onPress={(state) => {
                                dispatch(add_exercise_set({restTime: 0, isComplete: false, exercise_id: workoutExercise._id }))
                            }}>
                            Add Set
                            </Button>
                        </>
                                    ...
                                    <View style={styles.setInfo}>
                                        ...
                                        <View style={{flex:2, flexDirection: 'row', justifyContent: 'flex-start'}}>
                                            <Caption >
                                                ...
                                                : exercise.exerciseType === 'Timed' ? '999lbs, 9:99:99' :'999km, 9:99:99' }
                                            </Caption> 
                                        </View> 
                                    </View>    
                                    <View style={styles.metricsInfo}>     
