...
const WorkoutExerciseContainer = ({ workoutExercise }) => {
    ...
    const sets = useSelector(selectAllSets(state, workoutExercise.exercise_id))
                        ...
                        return (
                            <>
                                ...
                                <View style={styles.parentRow}>
                                    ...
                                    <TextInput style={{ backgroundColor: 'transparent'}} keyboardType='numeric' value={`${set.weight}`} placeholder='-' dense/>
                                    <Caption>Reps</Caption> 
                                    <TextInput style={{ backgroundColor: 'transparent'}} keyboardType='numeric' value={`${set.reps}`} placeholder='-' dense/>
                                    </View>
