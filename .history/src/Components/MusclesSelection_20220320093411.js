...
const MusclesSelection = ({onSelect, initialValues }) => {
    ...
    return ( 
        <>
            <Chip style={styles.chip}
                disabled={initialValues.allDisabled}
                icon={ initialValues.selectedMuscles.includes('Chest') ? 'checkmark-circle' : 'add-circle-outline'} 
                mode='outlined'
