...
import MainDrawerNavigator from './src/Navigation/MainNavigation';   // Main App Navigation
import AuthStackNavigator from './src/Navigation/AuthNavigation';    // Auth Navigation
...
import { Provider as WorkoutProvider }   from './src/Contexts/WorkoutContext';
...
export default () => {
    ...
    return (
        <AuthProvider>
            <WorkoutProvider>
                <ExerciseProvider>
                    <PaperProvider theme={DefaultTheme} settings={{icon: props => <Ionicons {...props} />,}}>
                        <App />
                    </PaperProvider>
                </ExerciseProvider>
            </WorkoutProvider>
